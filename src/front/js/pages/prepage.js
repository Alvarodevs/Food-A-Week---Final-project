			...
			<div className="row">
				<div className="first-element col-9">
					<div className="head-prepage d-flex justify-content-begin d-flex ">
						<div className="title-web ml-5 mr-auto p-1">Food A Week</div>
					</div>
				</div>
			</div>
			<div className="row">
				<div className=" col-8 text-pre-page d-flex flex-column align-items-end  ">
					<p className="prepage-text">Search your favorite recipes & save your weekplan</p>
				</div>
			</div>

			<div className="col-4 mt-2 signElements">
				<Accordion>
					<Card>
						<Card.Header>
